          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
              <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                  <a class="nav-link active" href="?mod=home">Home</a>
                </li>
                <li class="nav-item">
        ...
        <div class="container">
          ...
          <div class="row blog-entries">
            <div class="col-md-12 col-lg-8 main-content">
              <div class="row">
                <?php 
                    foreach ($posts_page as $key => $value) {
                      foreach ($users as $key => $value1) {
                        if($value1['id']==$value['user_id']) $user=$users[$key];
                      }
                 ...
                 ?>
                <div class="col-md-6">
                  <a href="?mod=home&act=detail&id=<?= $value['id'] ?>&slug=<?=$value['slug']?>" class="blog-entry element-animate" data-animate-effect="fadeIn">
