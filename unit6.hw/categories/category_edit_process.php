<?php  
  ...
  //       	$file_infor = pathinfo($_FILES['img']['name']);
	...
	if($_POST['parent_id']==0){
		...
		if($thumbnail==""){
			$query = "UPDATE categories SET name='".$_POST['name']."',parent_id='".$_POST['parent_id']."', slug='".$_POST['slug']."',  description='".$_POST['description']."', updated_at='".date('y-m-d h:m:s')."' WHERE id=".$_POST['id'];
		}else{
			$query = "UPDATE categories SET name='".$_POST['name']."',parent_id='".$_POST['parent_id']."', slug='".$_POST['slug']."', thumbnail='".$thumbnail."', description='".$_POST['description']."', updated_at='".date('y-m-d h:m:s')."' WHERE id=".$_POST['id'];
		}
